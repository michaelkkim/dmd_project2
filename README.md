...
### `code1/...`
- `stan_fit_all1.R` executes Hamiltonian Monte Carlo (HMC) with No-U-Turn Sampler (NUTS) implemented in `Stan` software for our joint nonlinear mixed-effects (NLME) model of Duchenne muscular dystrophy (DMD) data (incomplete longitudinal trajectories of 6MWD and MRI-T2 of five leg muscles) -- see Section 3.1 of paper; also contains code for `stan_results` outputs folder
