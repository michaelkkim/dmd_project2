# dmd_project2
Paper: A novel approach to optimize composite biomarkers for continuous measures of clinical function: Application to muscle imaging biomarkers in Duchenne muscular dystrophy
...
- `grid_it_weights_joint.R` executes main algorithm for computing posterior samples of weights of one-year MRI-T2 changes of five leg muscles across a fine grid of 6MWD values; also contains code for `main_plots` outputs folder
